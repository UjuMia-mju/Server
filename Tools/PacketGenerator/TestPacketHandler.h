...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_C_GET_DB_DATA] = [](PacketSessionRef& session, BYTE* buffer, int32 len)
		{
			return HandlePacket<Protocol::C_GET_DB_DATA>(Handle_C_GET_DB_DATA, session, buffer, len);
		};
		GPacketHandler[PKT_C_TEST_ENTER_ROOM] = [](PacketSessionRef& session, BYTE* buffer, int32 len)
		{
			return HandlePacket<Protocol::C_TEST_ENTER_ROOM>(Handle_C_TEST_ENTER_ROOM, session, buffer, len);
		};
		GPacketHandler[PKT_C_RELAY_PACKET] = [](PacketSessionRef& session, BYTE* buffer, int32 len)
		{
			return HandlePacket<Protocol::C_RELAY_PACKET>(Handle_C_RELAY_PACKET, session, buffer, len);
		};
		...
		GPacketHandler[PKT_C_GET_CURRENCY] = [](PacketSessionRef& session, BYTE* buffer, int32 len)
		{
			return HandlePacket<Protocol::C_GET_CURRENCY>(Handle_C_GET_CURRENCY, session, buffer, len);
		};
		...
		GPacketHandler[PKT_C_HOST_SHOW_STAGE] = [](PacketSessionRef& session, BYTE* buffer, int32 len)
		{
			return HandlePacket<Protocol::C_HOST_SHOW_STAGE>(Handle_C_HOST_SHOW_STAGE, session, buffer, len);
		};
	...
	static SendBufferRef MakeSendBuffer(Protocol::S_RELAY_PACKET& pkt) { return MakeSendBuffer(pkt, PKT_S_RELAY_PACKET); }
	static SendBufferRef MakeSendBuffer(Protocol::S_LOGIN& pkt) { return MakeSendBuffer(pkt, PKT_S_LOGIN); }
	static SendBufferRef MakeSendBuffer(Protocol::S_GET_CURRENCY& pkt) { return MakeSendBuffer(pkt, PKT_S_GET_CURRENCY); }
	static SendBufferRef MakeSendBuffer(Protocol::S_GACHA& pkt) { return MakeSendBuffer(pkt, PKT_S_GACHA); }
	static SendBufferRef MakeSendBuffer(Protocol::S_GACHA_POOL_LIST& pkt) { return MakeSendBuffer(pkt, PKT_S_GACHA_POOL_LIST); }
	static SendBufferRef MakeSendBuffer(Protocol::S_SKIN_LIST& pkt) { return MakeSendBuffer(pkt, PKT_S_SKIN_LIST); }
	static SendBufferRef MakeSendBuffer(Protocol::S_MY_SKINS& pkt) { return MakeSendBuffer(pkt, PKT_S_MY_SKINS); }
	...
	static SendBufferRef MakeSendBuffer(Protocol::S_INVITE_PLAYER& pkt) { return MakeSendBuffer(pkt, PKT_S_INVITE_PLAYER); }
	static SendBufferRef MakeSendBuffer(Protocol::S_INVITE_NOTIFICATION& pkt) { return MakeSendBuffer(pkt, PKT_S_INVITE_NOTIFICATION); }
	static SendBufferRef MakeSendBuffer(Protocol::S_INVITE_RESPONSE& pkt) { return MakeSendBuffer(pkt, PKT_S_INVITE_RESPONSE); }
	static SendBufferRef MakeSendBuffer(Protocol::S_ROOM_MEMBER_ENTER& pkt) { return MakeSendBuffer(pkt, PKT_S_ROOM_MEMBER_ENTER); }
	static SendBufferRef MakeSendBuffer(Protocol::S_ROOM_MEMBER_LEAVE& pkt) { return MakeSendBuffer(pkt, PKT_S_ROOM_MEMBER_LEAVE); }
	static SendBufferRef MakeSendBuffer(Protocol::S_READY& pkt) { return MakeSendBuffer(pkt, PKT_S_READY); }
	static SendBufferRef MakeSendBuffer(Protocol::S_START_ROOM& pkt) { return MakeSendBuffer(pkt, PKT_S_START_ROOM); }
	static SendBufferRef MakeSendBuffer(Protocol::S_CHAT& pkt) { return MakeSendBuffer(pkt, PKT_S_CHAT); }
	static SendBufferRef MakeSendBuffer(Protocol::S_STAGE_INFO& pkt) { return MakeSendBuffer(pkt, PKT_S_STAGE_INFO); }
	static SendBufferRef MakeSendBuffer(Protocol::S_SHOW_STAGE& pkt) { return MakeSendBuffer(pkt, PKT_S_SHOW_STAGE); }
	static SendBufferRef MakeSendBuffer(Protocol::S_HOST_SHOW_STAGE& pkt) { return MakeSendBuffer(pkt, PKT_S_HOST_SHOW_STAGE); }
	static SendBufferRef MakeSendBuffer(Protocol::S_START_STAGE& pkt) { return MakeSendBuffer(pkt, PKT_S_START_STAGE); }
	static SendBufferRef MakeSendBuffer(Protocol::S_GET_CLEAR_INFO& pkt) { return MakeSendBuffer(pkt, PKT_S_GET_CLEAR_INFO); }
	static SendBufferRef MakeSendBuffer(Protocol::S_ENTER_GAME& pkt) { return MakeSendBuffer(pkt, PKT_S_ENTER_GAME); }
	static SendBufferRef MakeSendBuffer(Protocol::S_GAME_READY_TO_START& pkt) { return MakeSendBuffer(pkt, PKT_S_GAME_READY_TO_START); }
	static SendBufferRef MakeSendBuffer(Protocol::S_GAME_CLEAR& pkt) { return MakeSendBuffer(pkt, PKT_S_GAME_CLEAR); }
	...
	static SendBufferRef MakeSendBuffer(Protocol::S_PLAYER_LEAVE& pkt) { return MakeSendBuffer(pkt, PKT_S_PLAYER_LEAVE); }
	static SendBufferRef MakeSendBuffer(Protocol::S_PLAYER_ANIMATION& pkt) { return MakeSendBuffer(pkt, PKT_S_PLAYER_ANIMATION); }
	static SendBufferRef MakeSendBuffer(Protocol::S_PLAYER_STAT& pkt) { return MakeSendBuffer(pkt, PKT_S_PLAYER_STAT); }
	static SendBufferRef MakeSendBuffer(Protocol::S_OBJECT_PICKUP& pkt) { return MakeSendBuffer(pkt, PKT_S_OBJECT_PICKUP); }
	static SendBufferRef MakeSendBuffer(Protocol::S_OBJECT_DROP& pkt) { return MakeSendBuffer(pkt, PKT_S_OBJECT_DROP); }
	static SendBufferRef MakeSendBuffer(Protocol::S_OBJECT_MOVE& pkt) { return MakeSendBuffer(pkt, PKT_S_OBJECT_MOVE); }
